...
async function main() {
    groq.chat.completions.create({
        ...
        messages: [
            ...
            { role: "assistant", content: "Création d'une instance avec groq-sdk role:user,name:@Melvynx sous forme de session brainstorming"},
            { role: "user",name:"@melvynx", content: "bonjours,`groq{role:system`,name:Pi,content:/devOPs()"},
            { role: "user",name:"@youtube", content: "Optimisation du code css et javascript avec bootstrap pour notre page"},
            { role: "assistant",name:"",content:"Rédigez page HTML en response au message instance entre les roles:assistant et role:system!"},
        ],
