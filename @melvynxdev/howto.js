...
const groq = new Groq();
const instructions = require("./howto.js");
// Liste de citations prédéfinies
const instruction = [
    {
        "instruction": "génère-moi un tutoriel sur [les flux streaming sur Youtube et les étapge pour généré et composant des video de types short, réel ]]!",
        "auteur": "Pi 3,14"
    }
